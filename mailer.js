// services/mailer.js — Nodemailer email notification service
...
const sendProjectNotification = async (project) => {
  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>Apex Creations Admin System · Auto-notification</p>
          <p>📞 +251970061607 · +251976062692</p>
        </div>
      </div>
    </body>
    </html>
  ...
  await mailer.sendMail({
    ...
    subject: `🚀 New Project: ${project.project_name} — ${project.project_type}`,
    html,
  });
};
